## KFC Toolkit - Web Frontend 
This contains all React based web component of the toolkit.

The module was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app). As such, various tasks are the same as a blank Create-React-App. 
...
- [Available Scripts](#available-scripts)
  - [yarn start / npm start](#yarn-start-or-npm-start)
  - [yarn test / npm test](#npm-test)
...
Create React App, which this module is generated from, is divided into two packages:
...
`yarn build` or `npm run build` creates a `build` directory with a production build of your app. `toolkit-backend` module could serve as the HTTP server so that a user to your app is served `index.html`, and requests to static paths like `/static/js/main.<hash>.js` are served with the contents of the `/static/js/main.<hash>.js` file.

In building the toolkit, this module will be packaged into a jar dependary for `toolkit-backend`, which in turn, package into a fully functional Spring Boot based web app.

The `build` folder with static assets is the only output produced.
